                                          ...
                                          const bool traversed_in_reverse)
{
    ...
    if (util::coordinate_calculation::greatCircleDistance(turn_coordinate, post_turn_coordinate) <= 1)
    {
                                          ...
                                          const bool traversed_in_reverse)
{
    ...
    if (util::coordinate_calculation::greatCircleDistance(turn_coordinate, pre_turn_coordinate) <= 1)
    {
