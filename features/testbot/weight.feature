...
Feature: Weight tests
    ...
    Scenario: Start and target on the same and adjacent edge
        ...
        When I route I should get
            ...
            | s,t       | abc,abc | 20m,0m    | 2,0     | 2s,0s   | 20.034844           | 2          | 2        | 10      |
            | t,s       | abc,abc | 20m,0m    | 2,0     | 2s,0s   | 20.034844           | 2          | 2        | 10      |
            | s,e       | abc,abc | 40m,0m    | 3.9,0   | 3.9s,0s | 29.940962:10.017422 | 3:0.9      | 3:0.9    | 10:11.1  |
            | e,s       | abc,abc | 40m,0m    | 3.9,0   | 3.9s,0s | 10.017422:29.940962 | 0.9:3      | 0.9:3    | 11.1:10  |
